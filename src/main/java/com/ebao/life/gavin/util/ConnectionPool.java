...
public class ConnectionPool {
	...
	private int maxConnections = 8; // 连接池最大的大小
	...
	private PooledConnection getFreeConnection() throws SQLException {
		...
		if (conn == null) {
			...
			// 如果目前连接池中没有可用的连接
			// 创建一些连接
			logger.info("目前连接池中没有可用的连接,创建一些连接 ");
...
//			}
	...
	Vector<PooledConnection> getConnections(){ //包访问权限
		return connections;
	}
